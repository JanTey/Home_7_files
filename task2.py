...
def get_shop_list_by_dishes(dishes, persons=int):
    ...
    try:
        ...
        print(f'Для приготовления блюд {a} и {b} на {persons} человека необходимо купить:')
        pprint.pprint(shopping_list)
    except KeyError:
        print("Вы ошиблись в названии блюда")
a = input('Введите название блюда и нажмите "Enter": ')
b = input('Введите название блюда и нажмите "Enter": ')
n = int(input('Введите количество персон и нажмите "Enter": '))
get_shop_list_by_dishes([a, b], n)